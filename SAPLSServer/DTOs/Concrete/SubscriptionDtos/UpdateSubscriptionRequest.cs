...
namespace SAPLSServer.DTOs.Concrete.SubscriptionDtos
{
    public class UpdateSubscriptionRequest : UpdateRequest
    {
        ...
        [Range(minimum: 1, maximum: double.PositiveInfinity, ErrorMessage = MessageKeys.SUBSCRIPTION_DURATION_INVALID)]
        public int Duration { get; set; }

        [Required(ErrorMessage = MessageKeys.SUBSCRIPTION_DURATION_REQUIRED)]
        [Range(minimum: 1, maximum: double.PositiveInfinity, ErrorMessage = MessageKeys.SUBSCRIPTION_PRICE_INVALID)]
