...
namespace SAPLSServer.Services.Interfaces
{
    public interface IWhitelistService
    {
        ...
        Task<PageResult<WhitelistAttendantDto>> GetWhitelistAtten???tsPage(PageRequest request);
        Task<PageResult<WhitelistAttendantDto>> GetWhitelistAttendantsByEmailPage(string email, PageRequest request);
        Task<PageResult<WhitelistAttendantDto>> GetActiveWhitelistAtten???tsPage(PageRequest request);
        Task<PageResult<WhitelistAttendantDto>> GetExpiredWhitelistAtten???tsPage(PageRequest request);
