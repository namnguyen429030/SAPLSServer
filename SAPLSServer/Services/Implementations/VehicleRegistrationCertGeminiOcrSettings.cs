...
{
    public class VehicleRegistrationCertGeminiOcrSettings : IVehicleRegistrationCertOcrSettings
    {
        private readonly string _baseUrl;
        private readonly string _modelName;
        private readonly string _apiKey;
        public VehicleRegistrationCertGeminiOcrSettings(IConfiguration configuration)
        {
